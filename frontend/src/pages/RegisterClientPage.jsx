...
function RegisterClientPage() {
  ...
  const inputDugmeKlasa =
    "w-full  bg-white text-sncdblue outline-none hover:ring-1 hover:ring-snclblue focus:ring-2 focus:ring-snclblue rounded-lg p-1 shadow-lg";
  const inputDugmeKlasaLosa =
    "w-full  ring-red ring-1  bg-white text-sncdblue outline-none rounded-lg p-1 shadow-lg";
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      //     if (user1) {
      //       const token = await user1.getIdTokenResult();
      ...
      //   return () => unsubscribe();
      // }, []);
      await fetch("http://localhost:5555/mladenci", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          ImePartneta: values.imePartnera,
          PrezimePartnera: values.prezimePartnera,
  ...
  return (
    <div className="flex w-full flex-row flex-wrap-reverse items-center justify-center">
      ...
      <form
        ...
        className="m-6 mx-10 grid h-fit min-w-96 max-w-96 rounded-xl bg-snclbrown p-6 text-white shadow-lg"
      >
        <p className="text-xl font-extrabold text-snclgray">
          {t("registerPage")}
        </p>
        <div className="mt-5">
          <div className="flex flex-row">
            <div className="mr-2">
              ...
              />
              {errors.ime && touched.ime && (
                <p className="text-red">{errors.ime}</p>
              )}
            </div>
            <div className="ml-2">
              <p>{t("loginSurname")}</p>
              ...
              />
              {errors.prezime && touched.prezime && (
                <p className="text-red">{errors.prezime}</p>
              )}
            </div>
          </div>
          <div className="flex flex-row">
            <div className="mr-2">
              ...
              <input
                name="imePartnera"
                className={
                  errors.imePartnera && touched.imePartnera
                    ? inputDugmeKlasaLosa
                    : inputDugmeKlasa
                }
                onChange={handleChange}
              ...
              />
              {errors.imePartnera && touched.imePartnera && (
                <p className="text-red">{errors.imePartnera}</p>
              )}
            </div>
            <div className="ml-2">
              ...
              <input
                ...
                className={
                  errors.prezimePartnera && touched.prezimePartnera
                    ? inputDugmeKlasaLosa
                    : inputDugmeKlasa
                }
                onChange={handleChange}
              ...
              />
              {errors.prezimePartnera && touched.prezimePartnera && (
                <p className="text-red">{errors.prezimePartnera}</p>
              )}
            </div>
          </div>
          <div className="">
        ...
        <div className="mt-5 flex justify-end">
          <Button
            ...
            className={
              !(dirty && isValid)
                ? "my-6 h-10 w-1/3  rounded-lg bg-snclgray shadow-lg"
                : "my-6 h-10 w-1/3  rounded-lg bg-sncpink shadow-lg hover:bg-snclpink"
            }
          >
            {t("register")}
          </Button>
        ...
        <div className="flex flex-row">
          <p>{t("alreadyHave")}</p>
          <span>
            <Link to="/login" className="mx-2 text-sncpink">
              {t("login")}
            </Link>
          </span>
        </div>
