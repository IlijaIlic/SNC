...
function ChooseRegisterPage() {
  ...
  return (
    <div className="relative flex w-full flex-col items-center justify-center bg-gray-100 py-10">
      <h1 className="mb-8 text-3xl font-bold text-sncpink">{t('Choose your role')}</h1>

      <div className="mb-8 flex flex-wrap">
        <Link
          to="/register/client"
          className="m-3 flex h-12 w-40 items-center justify-center rounded-md bg-sncpink p-2 text-center font-semibold text-white shadow-lg transition-colors duration-300 hover:animate-pop hover:bg-sncgradientpink"
        >
          {t('newlywed')}
        </Link>
      </div>
      ...
      <div className="absolute left-0 top-0 flex h-full w-20 flex-col items-center justify-center bg-transparent">
        <svg className="mb-4 h-8 w-8 text-snclbrown" fill="pink" viewBox="0 0 24 24">
