...
import {
  HiOutlineOfficeBuilding, HiCamera, HiCake, HiSparkles,
} from 'react-icons/hi';
...
import OglasiCardRestoran from '../OglasiComponents/OglasiCardRestoran';

// PREVEDENO

function OglasiPageRestoran() {
        ...
        <div className="m-4 flex w-full h-full flex-row flex-wrap ">
          {filteredPosts.map((restoran, index) => (
            <div key={index} className="mb-8 ml-12 mr-2 h-2/6 w-3/12 min-w-96">
              <OglasiCardRestoran restoran={restoran} />
            </div>
          ))}
        </div>
      </div>
...
export default OglasiPageRestoran;
