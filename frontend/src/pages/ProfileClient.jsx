...
import {
  Button, Tab, TabPanel, Tabs, TabsList,
} from '@mui/base';
...
function ProfileClient() {
  ...
  useEffect(() => {
    async function fetchProfileData() {
      try {
        ...
        console.log('OKVIR');
        console.log(fetchedDataMladenci);
        console.log('OKVIR');

        // const responseLikedRestoran = await axios.get(
        //   `http://localhost:8080/getLikedRestoran/${auth.currentUser.uid}`,
        // );
        // const restoranPromises = responseLikedRestoran.data.map((restoran) => axios.get(
        ...
        // );
        // const fotografiPromises = responseLikedFotograf.data.map((fotograf) => axios.get(
        ...
        setImePartnera(fetchedDataMladenci.imePartneta);
        setPrezimePartnera(fetchedDataMladenci.prezimePartnera);
        setEmail(fetchedDataMladenci.email);
        setBrojTelefona(fetchedDataMladenci.brojTelefona);
      } catch (error) {
  ...
  const handleUkloniPoslasticara = async (id) => {
    try {
      ...
      setSacuvaniPoslasticari((prevPoslasticari) => prevPoslasticari.filter(
                  ...
                  >
                    ...
                    <div>
                      <Tooltip title="Ukloni" arrow placement="top">
                        <Button
                          className="mx-1 rounded-lg  px-3 py-1 text-center text-xs text-white hover:text-sncdblue"
                          onClick={() => handleUkloniDekoratera(oglas.DekoraterID)}
                        >
                          <HeartBrokenIcon />
                        </Button>
                      </Tooltip>
                      <Tooltip title="Poseti" arrow placement="top">
                        <Button
                          className="mx-1 rounded-lg  px-3 py-1 text-center text-xs text-white hover:text-sncdblue"
                          onClick={() => handlePosetiDekoratera(oglas.DekoraterID)}
                        >
                          <ArrowForwardIcon />
                        </Button>
                      </Tooltip>
                  ...
                  >
                    ...
                    <div>
                      <Tooltip title="Ukloni" arrow placement="top">
                        <Button
                          className="mx-1 rounded-lg  px-3 py-1 text-center text-xs text-white hover:text-sncdblue"
                          onClick={() => handleUkloniFotografa(oglas.FotografID)}
                        >
                          <HeartBrokenIcon />
                        </Button>
                      </Tooltip>
                      <Tooltip title="Poseti" arrow placement="top">
                        <Button
                          className="mx-1 rounded-lg  px-3 py-1 text-center text-xs text-white hover:text-sncdblue"
                          onClick={() => handlePosetiFotografa(oglas.FotografID)}
                        >
                          <ArrowForwardIcon />
                        </Button>
                      </Tooltip>
                  ...
                  >
                    ...
                    <div>
                      <Tooltip title="Ukloni" arrow placement="top">
                        <Button
                          className="mx-1 rounded-lg  px-3 py-1 text-center text-xs text-white hover:text-sncdblue"
                          onClick={() => handleUkloniPoslasticara(oglas.PoslasticarID)}
                        >
                          <HeartBrokenIcon />
                        </Button>
                      </Tooltip>
                      <Tooltip title="Poseti" arrow placement="top">
                        <Button
                          className="mx-1 rounded-lg  px-3 py-1 text-center text-xs text-white hover:text-sncdblue"
                          onClick={() => handlePosetiPoslasticara(oglas.PoslasticarID)}
                        >
                          <ArrowForwardIcon />
                        </Button>
                      </Tooltip>
